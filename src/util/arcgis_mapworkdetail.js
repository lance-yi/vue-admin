    ...
    methods: {
        ...
        initMap(obj) {
            ...
            this.mapObj.map = map;
                ...
                let pt = new obj.Point(this.propsgps.maintenancerLongitude, this.propsgps.maintenancerLatitude); // 设置中心点
                map.centerAndZoom(pt,12); // 设置中心点和缩放级别;
          
          
                this.createphone(this.propsgps)
                this.creategan(this.propsgps)
                 
                var linelist = [[this.propsgps.maintenancerLongitude, this.propsgps.maintenancerLatitude],[this.propsgps.deviceLongitude, this.propsgps.deviceLatitude]]    
                ...
                var polylineold = new esri.geometry.Polyline(linelist);
                ...
                var symbolold = new esri.symbol.SimpleLineSymbol(esri.symbol.SimpleLineSymbol.STYLE_DASHDOTDOT, new dojo.Color([257,7,7]), 2);
        ...
        createphone(el) {
            ...
            var labelPoint=new esri.geometry.Point(el.deviceLongitude,el.deviceLatitude);
            var labelSymbol =  new esri.symbol.PictureMarkerSymbol({
                url:require('../../public/img/142.png'),
                "height":20,
                "width":12,
                "type":"esriPMS",
                "angle": 0,
        ...
        creategan(el) {
            ...
            let gl = new this.mapObj.GraphicsLayer({id:c});
            this.mapObj.map.addLayer(gl);
            var labelPoint=new esri.geometry.Point(el.maintenancerLongitude, el.maintenancerLatitude);
            var labelSymbol =  new esri.symbol.PictureMarkerSymbol({
                url:require('../../public/img/143.png'),
                "height":20,
                "width":17,
                "type":"esriPMS",
                "angle": 0,
