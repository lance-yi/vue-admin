  ...
  <div @click="showno">
      ...
      <div v-if="statusdata" @click.stop="statusdata = true,bigrightshow = false,getwayip=''">
        ...
        <div class="statusbox" @click.stop="funs()">
            ...
            <Page :total="timelinelist.total" show-total v-if="timelinelist.list.length != 0&&this.levels == 2" :current.sync="oppages"  @on-change="changelevew2"/>
            <Page :total="timelinelist.total" show-total  v-if="timelinelist.list.length != 0&&this.levels == 1" :current.sync="oppages"  @on-change="changelevew1"/>
            <Page :total="timelinelist.total" show-total v-if="timelinelist.list.length != 0&&this.levels == 0" :current.sync="oppages"  @on-change="changelevew0"/>
            <Page :total="timelinelist.total" show-total v-if="timelinelist.list.length != 0&&this.levels == 4" :current.sync="oppages"  @on-change="changelevew4"/>
            ...
            <p v-if="timelinelist.list.length == 0&&this.levels == 0" style="padding:10px 0px;font-size:15px;color:#1DE509">暂无运行状态正常设备</p>
            <p v-if="timelinelist.list.length == 0&&this.levels == 4" style="padding:10px 0px;font-size:15px;color:#1D60FE">暂无安全接入网关</p>
            <div class="timelinebox" v-if="timelinelist.list.length != 0">
              <Timeline>
           ...
           <img src="../../public/img/xxx.png" style="position:absolute;right:30px;top:20px"  @click.stop="closebright"/>
            ...
            <div class="controls msgbox" v-if="!wangguanshow">
              <div v-if="msgtypelist.deviceName != '摄像机'">
                ...
                <p style="min-width:200px" >维护人员：<span style="color:#1D60FE;border-bottom:1px solid #1D60FE;cursor:pointer" @click="checkperson(msgtypelist.maintenanceUserId)">{{msgtypelist.maintenanceUserName}}</span></p>
              </div>
           ...
           <div class="detail-title" v-if="wangguanshow">
            ...
            <div class="detail-title" >
                ...
                <img slot="dot" src="../../public/img/ending.png" />
                   ...
                   <!-- <Page :total="oppagetotal" show-total :current.sync="oppages" :page-size="5" @on-change="changeoppage"/> -->
                </div>
  ...
  methods: {
    ...
    statusclick(index) {
      ...
      if (index == 0) {
        this.$http.get(
          ...
          { level: 2,requestModular:1,current:1,pageSize:10 },
          res => {
        ...
        this.$http.get(
          "alert/warning/getDeviceInfo?&param=",
          { level: 1 ,requestModular:1,current:1,pageSize:10 },
          res => {
            this.timelinelist = res.data
            this.levels = 1;
            this.move = false;
        ...
        this.$http.get(
          "alert/warning/getDeviceInfo?&param=",
          { level: 0 ,requestModular:1,current:1,pageSize:10 },
          res => {
            this.timelinelist = res.data;
            this.levels = 0;
            this.move = false;
        ...
        this.$http.get(
          "alert/warning/getDeviceInfo?&param=",
          { level: 4 ,requestModular:1,current:1,pageSize:10 },
          res => {
            this.timelinelist = res.data
            this.levels = 4;
            this.move = false;
    ...
    serach() {
      ...
      this.$http.get(
        ...
        { param: this.value, level: this.levels,requestModular:1,current:1,pageSize:10},
        res => {
          this.timelinelist = res.data
    ...
    changelevew4(i){
       this.$http.get(
          "alert/warning/getDeviceInfo?&param=",
          { level: 4 ,requestModular:1,current:i,pageSize:10 },
          res => {
            this.timelinelist = res.data
            this.levels = 4;
            this.move = false;
    ...
    changelevew0(i){
      this.$http.get(
          "alert/warning/getDeviceInfo?&param=",
          { level: 0 ,requestModular:1,current:i,pageSize:10 },
          res => {
            this.timelinelist = res.data
            this.levels = 0;
            this.move = false;
    ...
    changelevew1(i){
       this.$http.get(
          "alert/warning/getDeviceInfo?&param=",
          { level: 1 ,requestModular:1,current:i,pageSize:10 },
          res => {
            this.timelinelist = res.data
            this.levels = 1;
            this.move = false;
    ...
    changelevew2(i){
       this.$http.get(
          "alert/warning/getDeviceInfo?&param=",
          { level: 2,requestModular:1,current:i,pageSize:10 },
          res => {
            this.timelinelist = res.data
            this.levels = 2;
            this.move = false;
